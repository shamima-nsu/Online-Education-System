		...
		if( intval($uri)>=3)
		{
			...
			foreach ($result as $value) 
			{
				...
				if($value['UserRoleID']==="1")
					$UserRoleName[$count]="Student";
				else if($value['UserRoleID']==="2")
					$UserRoleName[$count]="Teacher";
				else
					$UserRoleName[$count]="Admin";
				$name[$count]=$value['Name'];
				$count++;
			}
			echo "<div class=\"form_title\"> All Users </div><br><br><br>";
